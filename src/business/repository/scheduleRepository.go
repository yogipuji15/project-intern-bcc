...
func (h *scheduleRepository) GetAllBySpeakerId(speakerId string, month string) ([]entity.Schedules, error) {
	...
	err := h.db.Where("time_start BETWEEN ? AND ?", month+"-01 00:00:00", month+"-28 23:59:00").Or("time_start BETWEEN ? AND ?", month+"-01 00:00:00", month+"-30 23:59:00").Or("time_start BETWEEN ? AND ?", month+"-01 00:00:00", month+"-31 23:59:00").Or("time_start BETWEEN ? AND ?", month+"-01 00:00:00", month+"-29 23:59:00").Find(&schedules, "speaker_id = ?", speakerId).Error
